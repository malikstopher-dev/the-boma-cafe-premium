      ...
      <div style={{ position: 'relative', height: '200px', overflow: 'hidden', flexShrink: 0 }}>
        {!imgError ? (
          <Image 
            ...
            onMouseEnter={(e) => { const t = e.currentTarget as HTMLElement; t.style.transform = 'scale(1.08)'; }}
            onMouseLeave={(e) => { const t = e.currentTarget as HTMLElement; t.style.transform = 'scale(1)'; }}
          />
        ) : (
          <div style={{ 
            width: '100%', 
      ...
      <main style={{ paddingTop: '80px' }}>
        ...
        <section style={{ background: 'var(--beige)', padding: 'var(--space-3xl) 5%', textAlign: 'center' }}>
          <div className="container">
            ...
            <h2 style={{ fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', color: 'var(--dark-brown)', marginBottom: '1rem' }}>Celebrate at The Boma</h2>
            ...
            <p style={{ color: 'var(--text)', marginBottom: '2rem', maxWidth: '550px', margin: '0 auto 2rem', lineHeight: 1.6 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0.75rem', maxWidth: '1000px', margin: '0 auto' }}>
              {eventGalleryImages.map((img, idx) => (
                <div key={idx} style={{ position: 'relative', aspectRatio: '1', borderRadius: '12px', overflow: 'hidden' }}>
                  <Image src={img} alt={`Event moment ${idx + 1}`} fill sizes="25vw" style={{ objectFit: 'cover' }} />
                </div>
              ))}
            </div>
