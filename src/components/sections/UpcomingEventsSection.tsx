        ...
        <div className={styles.eventsGrid}>
          <FadeInSection delay={200} className={styles.eventCardWrapper}>
            <Link href="/experience" className={styles.eventCard}>
              <div className={styles.eventCardImage}>
                <Image src="/gallery/weekend-buffet.jpg" alt="Weekend Breakfast Buffet" fill sizes="(max-width: 768px) 100vw, 400px" style={{ objectFit: 'cover' }} />
          ...
          <FadeInSection delay={300} className={styles.eventCardWrapper}>
            <Link href="/events" className={styles.eventCard}>
              <div className={styles.eventCardImage}>
                <Image src="/gallery/events/friday-braai.jpg" alt="Friday Braai Evening" fill sizes="(max-width: 768px) 100vw, 400px" style={{ objectFit: 'cover' }} />
                <div className={styles.eventOverlay} />
                <div className={styles.eventDate}>
          ...
          <FadeInSection delay={400} className={styles.eventCardWrapper}>
            <Link href="/entertainment" className={styles.eventCard}>
              <div className={styles.eventCardImage}>
                <Image src="/gallery/events/live-music.jpg" alt="Live Music Night" fill sizes="(max-width: 768px) 100vw, 400px" style={{ objectFit: 'cover' }} />
                <div className={styles.eventOverlay} />
                <div className={styles.eventDate}>
                  <span className={styles.eventDay}>SAT</span>
