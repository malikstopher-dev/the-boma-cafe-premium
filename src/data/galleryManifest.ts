...
export const galleryImages: Record<string, GalleryImage[]> = {
  events: [
    ...
    { url: '/gallery/events/slide2.webp', alt: 'Evening event' },
  ...
  people: [
    ...
    { url: '/gallery/people/bomacafe4_large.jpg', alt: 'Boma group' },
    { url: '/gallery/people/bomacafe2-large-1.jpg', alt: 'Venue guest' },
    { url: '/gallery/people/boma1-1152x864.jpeg', alt: 'Boma moment' },
    { url: '/gallery/people/gallery-7-800x600.jpeg', alt: 'Gallery people' },
    { url: '/gallery/people/e4aa64d9-3baf-4dbe-befb-883d90b96060.avif', alt: 'Guest portrait' },
