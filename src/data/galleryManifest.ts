...
export const galleryCategories: GalleryCategory[] = [
  { id: 'events', name: 'Events', folder: 'events', icon: 'Events' },
  { id: 'food', name: 'Food', folder: 'food', icon: 'Food' },
  { id: 'venue', name: 'Venue', folder: 'venue', icon: 'Venue' },
  { id: 'people', name: 'People', folder: 'people', icon: 'People' },
  { id: 'promotions', name: 'Promotions', folder: 'promotions', icon: 'Promotions' },
];

export const galleryImages: Record<string, GalleryImage[]> = {
  events: [
    { url: '/gallery/events/1777009767026-134-2000x1125.jpeg', alt: 'Main view' },
    ...
    { url: '/gallery/events/friday-braai.jpg', alt: 'Friday braai' },
    { url: '/gallery/events/images (1).jpg', alt: 'Guest photo' },
    { url: '/gallery/events/images (2).jpg', alt: 'Group photo' },
    { url: '/gallery/events/images (3).jpg', alt: 'Celebration' },
    { url: '/gallery/events/images (5).jpg', alt: 'Event celebration' },
    { url: '/gallery/events/images (6).jpg', alt: 'Event highlight' },
    { url: '/gallery/events/images (12).jpg', alt: 'Event photo' },
    { url: '/gallery/events/images (13).jpg', alt: 'Event moment' },
    { url: '/gallery/events/images (16).jpg', alt: 'Event gathering' },
    { url: '/gallery/events/images (17).jpg', alt: 'Event highlight' },
    { url: '/gallery/events/images.jpg', alt: 'Event' },
    { url: '/gallery/events/live-music.jpg', alt: 'Live music' },
    { url: '/gallery/events/mama-day.png', alt: 'Mama Day' },
    { url: '/gallery/events/OIP-1966289073.jpg', alt: 'Event gathering' },
    { url: '/gallery/events/slide.webp', alt: 'Event atmosphere' },
    { url: '/gallery/events/slide1.webp', alt: 'Event slideshow' },
    { url: '/gallery/events/slide2.webp', alt: 'Event moment' },
    { url: '/gallery/events/slide3.webp', alt: 'Event gathering' },
    { url: '/gallery/events/slide4.webp', alt: 'Event moment' },
    { url: '/gallery/events/slide5.webp', alt: 'Event celebration' },
    { url: '/gallery/events/slide6.webp', alt: 'Event evening' },
    { url: '/gallery/events/slide7.jpg', alt: 'Event highlight' },
  ],
  food: [
    ...
    { url: '/gallery/food/2026-03-27-2.webp', alt: 'Food platter' },
    { url: '/gallery/food/2026-03-27-3.webp', alt: 'Meal' },
  ...
  people: [
    { url: '/gallery/people/2025-07-20 (1).webp', alt: 'Guest photo' },
    { url: '/gallery/people/2026-04-08-3.webp', alt: 'Celebration' },
    { url: '/gallery/people/2026-04-08-5.webp', alt: 'Moment' },
    { url: '/gallery/people/495436022_18500503663027334_8147836249112744531_n.jpg', alt: 'Guest selfie' },
    { url: '/gallery/people/584554591_18543519472027334_7285782471694163241_n.jpg', alt: 'Group photo' },
    { url: '/gallery/people/boma1-1152x864.jpeg', alt: 'Boma moment' },
    { url: '/gallery/people/gallery-7-800x600.jpeg', alt: 'Gallery people' },
    { url: '/gallery/people/images (4).jpg', alt: 'Guest photo' },
    { url: '/gallery/people/images (8).jpg', alt: 'Guest photo' },
    { url: '/gallery/people/images (9).jpg', alt: 'Guest photo' },
    { url: '/gallery/people/images (10).jpg', alt: 'Guest photo' },
    { url: '/gallery/people/images (11).jpg', alt: 'Guest photo' },
    { url: '/gallery/people/images (14).jpg', alt: 'Guest photo' },
    { url: '/gallery/people/images (15).jpg', alt: 'Guest photo' },
    { url: '/gallery/people/mahendra.jpg', alt: 'Mahendra' },
  ...
  promotions: [
    ...
    { url: '/gallery/promotions/2025-08-23.jpg', alt: 'Winter special' },
    ...
    { url: '/gallery/promotions/2026-02-21.jpg', alt: 'February special' },
